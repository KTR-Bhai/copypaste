...
# Single, thread-safe SQLite connection
sqlite3.enable_callback_tracebacks(True)
DB_CONNECTION = sqlite3.connect(DB_PATH, timeout=10, check_same_thread=False)
DB_CONNECTION.execute("PRAGMA journal_mode=WAL")
DB_CONNECTION.execute("PRAGMA busy_timeout = 10000")
DB_LOCK = threading.Lock()  # Lock for serializing writes
